        ...
        return (
            <div className="container-fluid commitments" id="commitments">
                ...
                <div className="row  slideanim">
                    ...
                    <img className="lazyload" data-src={commit1} alt="commit-1" /><br />
                    <h4>正品保证</h4>
                    <p>严格控制供应渠道，全部商品均由品牌供应商直接采购供货，品质有保障。</p>
                    </div>
                    <div className="col-sm-6 commit">
                    <img className="lazyload" data-src={commit2} alt="commit-2" /><br />
                    <h4>支持退换货</h4>
                ...
                <div className="row slideanim">
                    ...
                    <img className="lazyload" data-src={commit3} alt="commit-3" /><br />
                    <h4>尽快发货</h4>
                    <p>我们会尽快安排发货，在发货后一般会在2-7天左右送达。</p>
                    </div>
                    <div className="col-sm-6 commit commit-bottom">
                    <img className="lazyload" data-src={commit4} alt="commit-4" /><br />
                    <h4>关于色差</h4>
